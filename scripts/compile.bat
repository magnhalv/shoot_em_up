...
set CommonCompilerFlags=-Od -MTd -nologo /utf-8 -fp:fast -fp:except- /GR- /EHa- /Z7 /Oi /WX /W4 /wd4201 /wd4100 /wd4189 /wd4505 /wd4127 /wd4190 -D_CRT_SECURE_NO_WARNINGS -FC /std:c++20 /arch:AVX2 /Zc:preprocessor
